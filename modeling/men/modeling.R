...
# data prep ----
clean_data <- read_csv("data/men/clean-data.csv")
# get just raw data
...
save(logit_model, en_model, rf_model, xgb_model, gam_model, 
     bayes_model, file = "modeling/men/models.RData")

# the models are all really close together. AUC is more useful than
# accuracy here because of calibration--how good is the model at
# identifying gaps?
# so xgb and gam should be defaults; maybe they should be the first
# weighted/esnemble model